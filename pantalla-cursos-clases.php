						...
						<div class="content flex-row-fluid" id="kt_content">
							...
							<div class="bgi-no-repeat bgi-position-center bgi-size-cover d-flex flex-column h-400px h-lg-500px">
                                ...
                                <div class="text-center">
                                    <img src="./src/media/examen.png" width="70px" height="70px" alt="">
                                    </div>
									<!--begin::Title-->
									<h3 class="fs-2x fw-bold text-white text-center mb-10 mb-lg-13 my-3">Rendir Exámen FrontEnd</h3>
									<div class="text-center">
									<a href="./materiales/Exámen-FrontEnd.pdf" download="examen-front-end-programandoConAgus.pdf" class="btn btn-icon-white btn-text-white">
...
<?php
                                ...
                                <div class="text-center">
									...
									<!--begin::Title-->
									<h3 class="fs-2x fw-bold text-white text-center mb-10 mb-lg-13 my-3">Rendir Exámen Backend</h3>
									<div class="text-center">
									<a href="./materiales/Exámen-BackEnd.pdf" download="examen-back-end-programandoConAgus.pdf" class="btn btn-icon-white btn-text-white">
									<i class="ki-duotone ki-file-down">
 										<span class="path1"></span>
 										<span class="path2"></span>
									</i>
...
<?php
                                ...
                                <div class="text-center">
									...
									<!--begin::Title-->
									<h3 class="fs-2x fw-bold text-white text-center mb-10 mb-lg-13 my-3">Editor de Código en Linea</h3>
									<!--end::Title-->
									<!--begin::Input group-->
			...
			<?php	 if ($numero_recibido==333) {
							...
							<div class="container">
								...
								<div class="card translate-middle-y mt-n10 mt-lg-n10">
									...
									<?php
                                    if ($numero_recibido != 99 && $numero_recibido != 100 && $numero_recibido != 98) {
										# code...
									...
									<?php
                                    if ($numero_recibido == 99 || $numero_recibido == 98) {
										# code...
									...
									?>
                                        ...
                                        <!--begin::Nav item-->
											<li class="nav-item my-3">
												<a class="btn btn-active-light-primary fw-bolder nav-link btn-color-gray-700 px-3 px-lg-8 mx-1 text-uppercase active" href="pantalla-cursos-clases.php?numero=<?=$numero_recibido?>">AGENDA TU EXÁMEN</a>
											</li>
									...
									<div class="card-body p-10 p-lg-15">
										...
										<div class="mb-17">
											...
											<div class="d-flex flex-stack mb-5">
												<!--begin::Title-->
												<h3 class="text-gray-900">Clases</h3>
												<!--end::Title-->
											</div>
											<?php
											}
...
<div class="calendly-inline-widget" data-url="https://calendly.com/programandoconagus/examenes" style="min-width:320px;height:700px;"></div>
...
<?php
											...
											<!--begin::Col-->
												<div class="col-md-12">
												<!-- Calendly inline widget begin -->
<div class="calendly-inline-widget" data-url="https://calendly.com/programandoconagus/examen-frontend" style="min-width:320px;height:700px;"></div>
<script type="text/javascript" src="https://assets.calendly.com/assets/external/widget.js" async></script>
<!-- Calendly inline widget end -->
												</div>
												<!--end::Col-->
...
<iframe src="https://codi.link/%7C%7C" style="border:0px #ffffff none;" name="myiFrame" scrolling="no" frameborder="1" marginheight="0px" marginwidth="0px" height="400px" width="600px" allowfullscreen></iframe>
											...
											<!--begin::Col-->
												<div class="col-md-4">
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/htmls.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://www.youtube.com/watch?v=Ni0Nmovfn0A&t=509s">
...
La etiqueta "html" y "head" 
La etiqueta "body" 
Encabezados ("h1" - "h6") 
Párrafos ("p") 
Enlaces ("a")
Imágenes ("img") 
Al finalizar, tendrás una comprensión sólida de cómo organizar el contenido de tu sitio web de manera efectiva.</div>
															<!--end::Text-->
															<!--begin::Content-->
											...
											?>
												...
												<div class="col-md-4">
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/htmls.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://www.youtube.com/watch?v=6KMerd5PNuU&t=2s">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
Al finalizar, serás capaz de construir formularios funcionales y estructurar información de manera clara y organizada.</div>
															<!--end::Text-->
															<!--begin::Content-->
															<div class="fs-6 fw-bold">
																<!--begin::Author-->
											...
											?>
												...
												<div class="col-md-4">
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/htmls.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://www.youtube.com/watch?v=XX3GwMAis8E&t=1s">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
La estructura básica de 'form' 

Diferentes tipos de 'input' (texto, correo, contraseña, fecha, etc.) 

Uso de 'label' para mejorar la accesibilidad 

Botones 'button' y su funcionalidad 

Listas desplegables 'select' y 'option' 

Al finalizar, serás capaz de diseñar formularios complejos y altamente funcionales para cualquier proyecto web. </div>
															<!--end::Text-->
															<!--begin::Content-->
															<div class="fs-6 fw-bold">
																<!--begin::Author-->
											...
											?>
												...
												<div class="col-md-4">
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/htmls.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://www.youtube.com/watch?v=a3BeEAgVBMw&t=12s">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
La estructura básica de 'table' 

Filas 'tr' y celdas 'td' 

Encabezados de tabla 'th' 

Al finalizar, serás capaz de construir tablas complejas y bien organizadas para mostrar información detallada en tus sitios web. </div>
															<!--end::Text-->
															<!--begin::Content-->
															<div class="fs-6 fw-bold">
																<!--begin::Author-->
												...
												<div class="col-md-4">
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/htmls.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://www.youtube.com/watch?v=sawEbfbTKdQ&t=4s">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
La etiqueta 'link' para vincular hojas de estilo externas.</div>
															<!--end::Text-->
															<!--begin::Content-->
															<div class="fs-6 fw-bold">
																<!--begin::Author-->
...
<div class="col-md-4">
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/OIP.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/pNpt8Oj2UIY">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<div class="col-md-4">
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/OIP.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/c0AATHvO-WQ">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
											...
											<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/js.png')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/YsBeds22UZA">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/js.png')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/eXRVBX05AY0">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/js.png')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/rRznCwd6nFk">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/js.png')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/Kq7vH-FSLHs">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/js.png')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/D3DW7zPswds">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/tsportada.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/6MNw3PQd3sE">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/tsportada.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/-i8MnTVtlVA">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/angularportada.png')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/uu1vouzrrYg">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/angularportada.png')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/xzrswDWb4v8">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/angularportada.png')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/QFqZT4iHnm0">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/angularportada.png')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/fpj4c4Br_t0">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/angularportada.png')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/n-oGf-R6RKg">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/angularportada.png')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/xAL10dW67dM">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/basededatos.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/Bmn9CdMbPdM">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/basededatos.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/ACy8ssXZVqo">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/basededatos.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/uB2N5BfnkAo">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/basededatos.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/6fln32wTlSU">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/basededatos.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/0641ug3ceog">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/basededatos.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/FnyAPdjIZZ8">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/git-portada.png')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/SSQhhWcxSbQ">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/git-portada.png')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/TLBnLQCEpvc">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/Diagramas-de-flujo.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/2in2woh6PhQ">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
...
<?php
											    ...
											    ?>
													...
													<div class="card-xl-stretch me-md-6">
														<!--begin::Image-->
														<a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5" style="background-image:url('./src/media/Apis-y-Endpoints.jpg')" data-fslightbox="lightbox-video-tutorials" href="https://youtu.be/EQmiaPS1KjI">
															<img src="assets/media/svg/misc/video-play.svg" class="position-absolute top-50 start-50 translate-middle" alt="" />
														</a>
														<!--end::Image-->
														<!--begin::Body-->
