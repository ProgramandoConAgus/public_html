										...
										<div class="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-500 fw-semibold my-5 my-lg-0 align-items-stretch px-2 px-lg-0" id="#kt_header_menu" data-kt-menu="true">
											...
											<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item here show menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
												...
												<span class="menu-link py-3">
													<span class="menu-title">Lenguajes</span>
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
											...
											<div class="menu-item px-3">
												<div class="menu-content d-flex align-items-center px-3">
													...
													<!--begin::Username-->
													<div class="d-flex flex-column">
														<div class="fw-bold d-flex align-items-center fs-5"><?=$_SESSION['apellidoSession']?> <?=$_SESSION['nombreSession']?> 
														<?php
                                                          if ($_SESSION['tipoIngresoSession'] == 1) {
															# code...
														  
														?>
                                                           <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Alumno</span>
														<?php
														}
                                                         else {
															# code...
														...
														?>
															<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Profesor</span>
														<?php
														}
														?>
														</div>
														<a href="#" class="fw-semibold text-muted text-hover-primary fs-7"><?=$_SESSION['emailSession']?></a>
													</div>
													<!--end::Username-->
												</div>
											</div>
											...
											<div class="menu-item px-5">
												<a href="metricas.php" class="menu-link px-5">Mis Métricas</a>
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
											<div class="menu-item px-5">
												<a href="authentication/layouts/corporate/sign-in.html" class="menu-link px-5">Cerrar Sesión</a>
											</div>
											<!--end::Menu item-->
										</div>
					...
					<div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							...
							<div class="page-title d-flex flex-column me-3">
								<!--begin::Title-->
								<h1 class="d-flex text-white fw-bold my-1 fs-3">Mis Métricas</h1>
								<!--end::Title-->
							</div>
							<!--end::Page title-->
						</div>
										...
										<div class="card-header py-7">
											...
											<div class="m-0">
												...
												<div class="d-flex align-items-center mb-2">
													<!--begin::Title-->
													<span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">Progreso General</span>
													<!--end::Title-->
													<!--begin::Label-->
												...
												<!--end::Heading-->
												<!--begin::Description-->
												<span class="fs-6 fw-semibold text-gray-500">Muestra la sumatoria del puntaje total de todos los ejercicios y exámenes entregados.</span>
												<!--end::Description-->
											</div>
											<!--end::Statistics-->
										</div>
									...
									<div class="card card-flush h-xl-100">
										...
										<div class="card-header py-7">
											...
											<div class="m-0">
												...
												<div class="d-flex align-items-center mb-2">
													<!--begin::Title-->
													<span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">Progreso por Lenguaje</span>
													<!--end::Title-->
													<!--begin::Label-->
													<span class="badge badge-light-success fs-base">
													<i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1">
												...
												<!--end::Heading-->
												<!--begin::Description-->
												<span class="fs-6 fw-semibold text-gray-500">Puntaje total por lenguaje.</span>
												<!--end::Description-->
											</div>
											<!--end::Statistics-->
										</div>
										...
										<div class="card-body card-body d-flex justify-content-between flex-column pt-3">
											...
											<div class="d-flex flex-stack">
												<!--begin::Flag-->
												<img src="../src/media/html.png" class="me-4 w-30px" style="border-radius: 4px" alt="" />
												<!--end::Flag-->
												<!--begin::Section-->
												<div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
													...
													<div class="me-5">
														<!--begin::Title-->
														<a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">HTML</a>
														<!--end::Title-->
														<!--begin::Desc-->
														<span class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">Estructura de una App</span>
														<!--end::Desc-->
													</div>
													<!--end::Content-->
													<!--begin::Wrapper-->
											...
											<div class="d-flex flex-stack">
												<!--begin::Flag-->
												<img src="../src/media/css.png" class="me-4 w-30px" style="border-radius: 4px" alt="" />
												<!--end::Flag-->
												<!--begin::Section-->
												<div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
													<!--begin::Content-->
													<div class="me-5">
														<!--begin::Title-->
														<a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">CSS</a>
														<!--end::Title-->
														<!--begin::Desc-->
														<span class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">Estilos de una App</span>
														<!--end::Desc-->
													</div>
													<!--end::Content-->
													<!--begin::Wrapper-->
											...
											<div class="d-flex flex-stack">
												<!--begin::Flag-->
												<img src="../src/media/js.png" class="me-4 w-30px" style="border-radius: 4px" alt="" />
												<!--end::Flag-->
												<!--begin::Section-->
												<div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
													<!--begin::Content-->
													<div class="me-5">
														<!--begin::Title-->
														<a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">JAVASCRIPT</a>
														<!--end::Title-->
														<!--begin::Desc-->
														<span class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">Funcionalidades de App</span>
														<!--end::Desc-->
													</div>
													<!--end::Content-->
													<!--begin::Wrapper-->
