																	...
																	<div class="col-lg-6 mb-3">
																		...
																		<div class="menu-item p-0 m-0">
																			...
																			<a href="pantalla-cursos-clases.php?numero=<?=$numeroSql?>" class="menu-link">
																				...
																				<span class="d-flex flex-column">
																					<span class="fs-6 fw-bold text-gray-800">Algoritmos</span>
																					<span class="fs-7 fw-semibold text-muted">Conoce como funcionan y aplicalos.</span>
																				</span>
																			</a>
																			<!--end:Menu link-->
																		</div>
						...
						<!--begin::Hero-->
							<div class="bgi-no-repeat bgi-position-center bgi-size-cover d-flex flex-column h-400px h-lg-500px">
                                ...
                                <div class="text-center">
                                    <img src="../src/media/moneda.png" width="70px" height="70px" alt="">
                                    </div>
									<!--begin::Title-->
									<h3 class="fs-2x fw-bold text-white text-center mb-10 mb-lg-13 my-3">Flash Clases</h3>
									<!--end::Title-->
									<!--begin::Input group-->
								...
								<div class="card translate-middle-y mt-n10 mt-lg-n10">
									...
									?>
                                        ...
                                        <!--begin::Nav item-->
											...
											<!--begin::Nav item-->
											<li class="nav-item my-3">
												<a class="btn btn-active-light-primary fw-bolder nav-link btn-color-gray-700 px-3 px-lg-8 mx-1 text-uppercase active" href="ejercicios.php?numero=<?=$numero_recibido?>">Ejercicios</a>
											</li>
											<!--end::Nav item-->
														...
														<div class="mb-9">
															...
															<div class="card card-bordered w-100">
																...
																<div class="card-body">
																	...
																	<div class="w-100 d-flex flex-stack mb-8">
																		...
																		<div class="d-flex align-items-center f">
																			...
																			<div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-gray-900">
																				...
																				<div class="d-flex align-items-center">
																					<!--begin::Username-->
																					<a href="pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Etiquetas Principales y Estructura - Ejercicio</a>
																					<!--end::Username-->
																					<span class="m-0"></span>
																				</div>
																				<!--end::Text-->
																	...
																	<!--end::Wrapper-->
																	<!--begin::Desc-->
																	<p class="fw-normal fs-5 text-gray-700 m-0 my-5">Practica las etiquetas mas usadas de HTML.</p>
																	<!--end::Desc-->
															...
															<div class="mb-10">
																...
																<div class="highlight">
																	...
																	<ul class="nav nav-pills" role="tablist">
																		<li class="nav-item">
																			<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_654c70592f5a6" role="tab">Respuesta</a>
																		</li>
																	</ul>
																	<div class="tab-content">
																		<div class="tab-pane fade show active" id="kt_highlight_654c70592f5a3" role="tabpanel">
																			<div class="highlight-code">
																				<pre class="language-html">
                                                                                <code class="language-html">
// Etiquetas de texto - Explicación
...
// Ejercicio: Crear una lista con navegación externa en cada uno de los items
</code>
</pre>
																			</div>
																		</div>
																		<div class="tab-pane fade" id="kt_highlight_654c70592f5a6" role="tabpanel">
																			<div class="highlight-code">
																				<pre class="language-html">
<code class="language-html">
...
&lt;ul&gt;
    &lt;li&gt;
        &lt;a href=&quot;https://www.rutaexterna.com&quot&gt;&lt;/a&gt;
    &lt;/li&gt;
