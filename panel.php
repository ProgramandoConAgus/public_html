													...
													<div class="scroll-y mh-325px my-5 px-8">
														...
														<div class="d-flex flex-stack py-4">
															...
															<div class="d-flex align-items-center">
																...
																<!--begin::Title-->
																<div class="mb-0 me-2">
																	<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Logica de Programación</a>
															...
															<!--end::Section-->
															<!--begin::Label-->
															<i class="ki-download fs-2 text-danger">
														    </i>
															<!--end::Label-->
														</div>
														<!--end::Item-->
														...
														<div class="d-flex flex-stack py-4">
															...
															<div class="d-flex align-items-center">
																...
																<!--begin::Title-->
																<div class="mb-0 me-2">
																	<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Diagramas de Flujo</a>
																	<div class="text-gray-500 fs-7">Descargar PDF</div>
																</div>
																<!--end::Title-->
															</div>
					...
					<div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							...
							<div class="page-title d-flex flex-column me-3">
								<!--begin::Title-->
								<h1 class="d-flex text-white fw-bold my-1 fs-3">Bienvenido a PCA Software - Comisión A1</h1>
								<!--end::Title-->
							</div>
							<!--end::Page title-->
						</div>
					...
					<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
						...
						<div class="content flex-row-fluid" id="kt_content">
									...
									<div class="card card-flush h-xl-100">
										...
										<div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px" style="background-image:url('assets/media/svg/shapes/top-green.png" data-bs-theme="light">
											...
											<h3 class="card-title align-items-start flex-column text-white pt-15">
												<span class="fw-bold fs-2x mb-3">Mis tareas</span>
												<div class="fs-4 text-white">
													<span class="opacity-75">Realiza el seguimiento a tu progreso y obetene metricas.</span>
												</div>
											</h3>
											<!--end::Title-->
											<!--begin::Toolbar-->
													...
													<div class="col-6">
														...
														<div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
															...
															<div class="m-0">
																...
																<!--end::Number-->
																<!--begin::Desc-->
																<span class="text-gray-500 fw-semibold fs-6">Ejercicios</span>
																<!--end::Desc-->
															</div>
															<!--end::Stats-->
														</div>
							...
							<div class="d-flex flex-wrap flex-stack mb-6">
								<!--begin::Heading-->
								<h3 class="fw-bold my-2">Tareas asignadas</h3>
								<!--end::Heading-->
							</div>
							<!--end::Toolbar-->
							<!--begin::Row-->
									...
									<a href="apps/projects/project.html" class="card border-hover-primary">
										...
										<div class="card-header border-0 pt-9">
											...
											<div class="card-toolbar">
												<span class="badge badge-light-primary fw-bold me-auto px-4 py-3">Asignado</span>
											</div>
											<!--end::Card toolbar-->
										</div>
										<!--end:: Card header-->
										...
										<div class="card-body p-9">
											<!--begin::Name-->
											<div class="fs-3 fw-bold text-gray-900">HTML Ejercicio / Exámen</div>
											<!--end::Name-->
											<!--begin::Description-->
											<p class="text-gray-500 fw-semibold fs-5 mt-1 mb-7">Lenguaje de estructura</p>
											<!--end::Description-->
											<!--begin::Info-->
											<div class="d-flex flex-wrap mb-5">
												<!--begin::Due-->
												<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
													<div class="fs-6 text-gray-800 fw-bold">23/08/2024</div>
													<div class="fw-semibold text-gray-500">Fecha Asignación</div>
												</div>
												<!--end::Due-->
											</div>
											<!--end::Info-->
											...
											<div class="h-4px w-100 bg-light mb-5" data-bs-toggle="tooltip" title="This project 50% completed">
												<div class="bg-danger rounded h-4px" role="progressbar" style="width: 100%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
											<!--end::Progress-->
											<!--begin::Users-->
