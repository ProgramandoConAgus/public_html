...
if ($datosUsuario) {
    ...
    echo "No se encontró ningún usuario con ID: " . $idUsuario;
}
						...
						<div class="content flex-row-fluid" id="kt_content">
							...
							<div class="bgi-no-repeat bgi-position-center bgi-size-cover d-flex flex-column h-400px h-lg-500px">
                                ...
                                <div class="text-center">
                                    <img src="./src/media/blancoPCA.png" width="170px" height="50px" alt="">
                                    </div>
									<!--begin::Title-->
									<h3 class="fs-2x fw-bold text-white text-center mb-10 mb-lg-13 my-3">Plataforma Exclusiva de Programación, Bienvenido <?=$_SESSION['nombre']?></h3>
							...
							<!--begin::Container-->
										...
										<!--begin::Separator-->
											...
											<div class="d-flex flex-stack mb-5">
												<!--begin::Title-->
												<h3 class="text-gray-900">Aprende en un mismo lugar</h3>
												<!--end::Title-->
											</div>
											<!--end::Content-->
											<!--begin::Separator-->
												...
												<div class="card-body py-6">
													...
													<div class="carousel-inner">
														...
														<div class="carousel-item show active">
															...
															<!--begin::Action-->
															<div class="m-0">
																<a href="ejercicios.php?numero=<?=$numeroHtml?>" class="btn btn-sm btn-light me-2 mb-2">Ejercicios</a>
																<a href="pantalla-cursos-clases.php?numero=<?=$numeroHtml?>" class="btn btn-sm btn-danger mb-2">Comenzar</a>
															</div>
															<!--end::Action-->
														</div>
														<!--end::Item-->
														...
														<div class="carousel-item show">
															...
															<!--begin::Action-->
															<div class="m-0">
																<a href="ejercicios.php?numero=<?=$numeroCss?>" class="btn btn-sm btn-light me-2 mb-2">Ejercicios</a>
																<a href="pantalla-cursos-clases.php?numero=<?=$numeroCss?>" class="btn btn-sm btn-danger mb-2">Comenzar</a>
															</div>
															<!--end::Action-->
														</div>
														<!--end::Item-->
														...
														<div class="carousel-item show">
															...
															<!--begin::Action-->
															<div class="m-0">
																<a href="ejercicios.php?numero=<?=$numerosJs?>" class="btn btn-sm btn-light me-2 mb-2">Ejercicios</a>
																<a href="pantalla-cursos-clases.php?numero=<?=$numeroJs?>" class="btn btn-sm btn-danger mb-2">Comenzar</a>
															</div>
															<!--end::Action-->
														</div>
														<!--end::Item-->
														...
														<div class="carousel-item show">
															...
															<!--begin::Action-->
															<div class="m-0">
																<a href="ejercicios.php?numero=<?=$numeroTs?>" class="btn btn-sm btn-light me-2 mb-2">Ejercicios</a>
																<a href="pantalla-cursos-clases.php?numero=<?=$numeroTs?>" class="btn btn-sm btn-danger mb-2">Comenzar</a>
															</div>
															<!--end::Action-->
														</div>
														<!--end::Item-->
														...
														<div class="carousel-item show">
															...
															<!--begin::Action-->
															<div class="m-0">
																<a href="ejercicios.php?numero=<?=$numeroAngular?>" class="btn btn-sm btn-light me-2 mb-2">Ejercicios</a>
																<a href="pantalla-cursos-clases.php?numero=<?=$numeroAngular?>" class="btn btn-sm btn-danger mb-2">Comenzar</a>
															</div>
															<!--end::Action-->
														</div>
														<!--end::Item-->
													...
													<div class="carousel-inner">
														...
														<div class="carousel-item show active">
															...
															<div class="d-flex align-items-center mb-9">
																...
																<div class="m-0">
																	<!--begin::Subtitle-->
																	<h4 class="fw-bold text-gray-800 mb-3">.NET</h4>
																	<!--end::Subtitle-->
																	<!--begin::Items-->
																	<div class="d-flex d-grid gap-5">
																		<!--begin::Item-->
															...
															<!--begin::Action-->
															<div class="m-0">
																<a href="ejercicios.php?numero=<?=$numeroNet?>" class="btn btn-sm btn-light me-2 mb-2">Ejercicios</a>
																<a href="pantalla-cursos-clases.php?numero=<?=$numeroNet?>" class="btn btn-sm btn-success mb-2">Comenzar</a>
															</div>
															<!--end::Action-->
														</div>
														<!--end::Item-->
														...
														<div class="carousel-item">
															...
															<!--begin::Action-->
															<div class="m-0">
																<a href="ejercicios.php?numero=<?=$numeroSql?>" class="btn btn-sm btn-light me-2 mb-2">Ejercicios</a>
																<a href="pantalla-cursos-clases.php?numero=<?=$numeroSql?>" class="btn btn-sm btn-success mb-2">Comenzar</a>
															</div>
															<!--end::Action-->
														</div>
														<!--end::Item-->
												...
												<div class="card-body py-6">
													...
													<div class="carousel-inner">
														...
														<div class="carousel-item show active">
															...
															<!--begin::Action-->
															<div class="m-0">
																<a href="ejercicios.php?numero=<?=111?>" class="btn btn-sm btn-light me-2 mb-2">Ejercicios</a>
																<a href="pantalla-cursos-clases.php?numero=<?=111?>" class="btn btn-sm btn-success mb-2">Comenzar</a>
															</div>
															<!--end::Action-->
														</div>
														<!--end::Item-->
